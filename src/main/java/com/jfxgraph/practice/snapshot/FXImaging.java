...
public class FXImaging
{
     ...
     * 
     * @param scene
     *            the scene which is to be imaged
     * @param save
     *            place where the image to be saved
     * @param width
     *            width of image
     * @param height
     *            height of image
    ...
    /**
     * This function helps to save the Node to Image and it's the only function which is public
     * 
     * @param node
     *            node to be saved
     * @param list
     *            list of children where the node is kept
     * @param save
     *            place where the image to be saved
     */
     ...
     * @param list
     *            the ObservableList of children where the node is kept
     * @param save
     *            place where the image to be saved
     * @param width
     *            width of image to be saved
     * @param height
     *            height of image to be saveed
     */
    ...
    /**
     * This is the main function to generate the graphics of the Node using the FXPanel inside the JFrame.
     * 
     * @param node
     * @param f
     * @param bound
    ...
    /**
     * This is the main function to generate the graphics of the scene using the FXPanel inside the JFrame.
     * 
     * @param sc
     * @param f
     * @param bound
    ...
    /**
     * This function saves the container as FXPanel to the Image using the Java API
     * 
     * @param container
     * @param bounds
     * @param file
    ...
    /**
     * This function restores the main Scene to the original Stage from where the event has been triggered
     */
    ...
    /**
     * This function is used to get the BufferedImage of the Container as JFXPanel
     * 
     * @param container
     * @param bounds
     * @return
